...
const About = () => {
    return (
        <section id="about" className="py-20 bg-dark overflow-hidden">
            <div className="max-w-7xl mx-auto px-8 sm:px-16 lg:px-24 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div className="order-1 lg:order-2 relative flex justify-center">
                    ...
                    <div className="relative z-10 w-full max-w-md aspect-square bg-slate-800 rounded-3xl overflow-hidden border border-white/10 shadow-2xl">
                        <img 
                            src="/hero.png" 
                            alt="Basuru Naveen" 
